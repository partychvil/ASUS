...
ARCH = arm
CROSS_COMPILE = /opt/fsl-imx/4.1.15-2.1.0/fb/sysroots/x86_64-pokysdk-linux/usr/bin/arm-poky-linux-gnueabi/arm-poky-linux-gnueabi-
KVER  := $(shell uname -r)
KSRC = /opt/fsl-imx/4.1.15-2.1.0/linux-imx-v2
INSTALL_PREFIX :=
MODDESTDIR := /opt/fsl-imx/4.1.15-2.1.0/linux-imx-v2/drivers/net/wireless/rtl8188eus
endif

ifeq ($(CONFIG_PLATFORM_HI_3521D), y)
EXTRA_CFLAGS += -DCONFIG_LITTLE_ENDIAN
ARCH = arm
CROSS_COMPILE = /opt/hisi-linux/x86-arm/arm-hisiv500-linux/target/bin/arm-hisiv500-linux-
KVER  := $(shell uname -r)
KSRC = /opt/hisi-linux/Hi3521DV100_SDK_V1.0.5.0/osdrv/opensource/kernel/linux-3.18.y
INSTALL_PREFIX :=
MODDESTDIR := /opt/hisi-linux/Hi3521DV100_SDK_V1.0.5.0/osdrv/opensource/kernel/linux-3.18.y/drivers/net/wireless/rtl8188eus
endif
